...
const CHAPTERS = [
  {
    ...
    fases: [
      ...
      { t: 'Ponte Maurício de Nassau', e: 9, fact: 'A Ponte Maurício de Nassau, de 1644, é tida como a primeira grande ponte do Brasil.' },
  ...
  },
  {
    ...
    fases: [
      { anchor: 2, e: 2 },
      { anchor: 3, e: 3 },
      { t: 'Piscinas Naturais', e: 9, fact: 'Na maré baixa, os arrecifes formam piscinas naturais mornas ao longo de Boa Viagem.' },
  ...
  },
  {
    ...
    fases: [
      ...
      { t: "Pé d'Água", e: 9, fact: "Pé d'água é como o recifense chama a chuva repentina que alaga tudo — e logo passa." },
  ...
  },
  {
    ...
    fases: [
      ...
      { t: 'Tapioca', e: 9, fact: 'Quentinha, com coco ou queijo: a tapioca atravessou séculos, das mãos indígenas até as nossas.' },
  ...
  },
  {
    ...
    fases: [
      ...
      { t: 'O Passo', e: 9, fact: 'Tesoura, parafuso, dobradiça: cada passo do frevo tem nome e personalidade próprios.' },
  ...
  },
  {
    ...
    fases: [
      ...
      { t: 'Mundo Livre S/A', e: 9, fact: 'O Mundo Livre S/A, de Fred 04, é o outro pilar fundador da cena manguebeat.' },
  ...
  },
  {
    ...
    fases: [
      ...
      { t: 'Encontro das Águas', e: 9, fact: 'No estuário, Capibaribe e Beberibe se abraçam antes de encontrar o mar.' },
